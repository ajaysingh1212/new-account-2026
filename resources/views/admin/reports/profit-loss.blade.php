...
<div class="report-card"><table class="table report-table"><tr><th>Particular</th><th>Amount</th></tr><tr><td>Sales</td><td>Rs {{ number_format($sales,2) }}</td></tr><tr><td>Purchase</td><td>Rs {{ number_format($purchases,2) }}</td></tr><tr><th>Net {{ $profit >= 0 ? 'Profit' : 'Loss' }}</th><th>Rs {{ number_format(abs($profit),2) }}</th></tr></table></div>
@endsection
