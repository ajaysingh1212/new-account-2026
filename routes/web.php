...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'verified', 'screen_unlocked'])->group(function () {
    ...
    Route::middleware('permission:delivery_challans.view')->group(function () {
        ...
        Route::get('pending-orders/{pendingOrder}/convert', [PendingOrderController::class, 'convertForm'])->middleware('permission:delivery_challans.edit')->name('pending-orders.convert-form');
